...
<head>
	<title>Progress Questionnaire</title>
</head>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card card-outline card-info">
				<div class="card-header">
					<b>Progress Questionnaire for Academic </b>
					<div class="card-tools">
						<button class="btn btn-sm btn-flat btn-primary bg-gradient-primary mx-1" id="eval_restrict" type="button">Progress Restriction</button>
						<button class="btn btn-sm btn-flat btn-success bg-gradient-success mx-1" form="order-question">Save Order</button>
					</div>
				</div>
				<div class="card-body">
					<fieldset class="border border-info p-2 w-100">
					   <legend  class="w-auto">Performance Assessment</legend>
					   <p>5 = Very Good, 4 = Good, 3 = Moderate, 2 = Weak, 1 = Very Weak</p>
					</fieldset>
