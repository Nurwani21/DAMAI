...
<div class="container-fluid">
	<form action="" id="manage-academic">
		...
		<div class="form-group">
			<label for="year" class="control-label">Week</label>
			<input type="text" class="form-control form-control-sm" name="year" id="year" value="<?php echo isset($year) ? $year : '' ?>" placeholder="" required>
		</div>
		<!--<div class="form-group">
